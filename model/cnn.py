...
def cnn_model(samples_num=100, test_size=0.3, epochs=50, batch_size=32, augment=False, augment_factor=2):
    from preprocess.preprocess import SEP28kPreprocessor
    print(f"Loading SEP28k data with max sample size: {samples_num}")
